// 本文件由脚本从 @iconify-json 生成，勿手改：把客户端组件用到的图标内置进来，
// 避免 @iconify/svelte 在运行时向 api.iconify.design / api.unisvg.com 请求图标。
import { addCollection } from "@iconify/svelte";

type IconSet = Parameters<typeof addCollection>[0];
