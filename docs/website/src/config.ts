...
export const siteConfig: SiteConfig = {
	title: "星露谷启动器",
	subtitle: "把游戏、SMAPI、Mod 和存档收进一个窗口里",

	lang: SITE_LANG,

	themeColor: {
		hue: 45, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				...
				"原版与 Mod 端各建各的实例，互不干扰",
				"在启动器内下载 Mod、装 SMAPI、开联机隧道",
				"主题可换、深浅可切，界面能透出自己的背景",
			],
			typewriter: {
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{ name: "赞助", url: "/helpus/", icon: "material-symbols:favorite-rounded" },
		{
			...
			children: [
				{ name: "GitHub 仓库", url: "https://github.com/OrangeArtc0915/SVE_mananger", external: true, icon: "fa6-brands:github" },
				{ name: "GitHub 下载", url: "https://github.com/OrangeArtc0915/SVE_mananger/releases", external: true, icon: "fa6-brands:github" },
				{ name: "Gitee 文件库", url: "https://gitee.com/orangearc655743/SVE_mananger_File", external: true, icon: "mdi:git" },
				{ name: "Gitee 下载", url: "https://gitee.com/orangearc655743/SVE_mananger_File/releases", external: true, icon: "mdi:git" },
			],
		},
	],
};
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		{ name: "GitHub", icon: "fa6-brands:github", url: "https://github.com/OrangeArtc0915/SVE_mananger" },
		{ name: "Gitee", icon: "mdi:git", url: "https://gitee.com/orangearc655743/SVE_mananger_File" },
		{ name: "QQ 群", icon: "fa6-brands:qq", url: "https://qm.qq.com/q/1034243331" },
	],
};
...
export const licenseConfig: LicenseConfig = {
	enable: true,
	name: "MIT",
	url: "https://github.com/OrangeArtc0915/SVE_mananger/blob/main/LICENSE",
};
...
export const announcementConfig: AnnouncementConfig = {
	...
	link: {
		enable: true, // 启用链接
		text: "看发行说明", // 链接文本
		url: "https://github.com/OrangeArtc0915/SVE_mananger/releases", // 链接 URL
		external: false, // 内部链接
	},
};
